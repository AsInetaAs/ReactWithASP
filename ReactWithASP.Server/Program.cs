...
var mySqlDb = configuration["MySQL:Db"];
var mySqlUser = configuration["MySQL:User"];
var mySqlPassword = configuration["MySQL:Password"];
...
app.Use((context, next) =>
{
   ...
   context.Response.Cookies.Append("XSRF-TOKEN", tokens.RequestToken!,
       new CookieOptions
       {
           HttpOnly = false, //allow the token to be read by JavaScript
